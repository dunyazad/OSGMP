...
namespace VEFM
{
	struct V3
	{
		...
		V3() : x(), y(), z() {}
		//V3(float x, float y, float z) : x(TrimFloat(x, 7)), y(TrimFloat(y, 7)), z(TrimFloat(z, 7)) {}
		//V3(const V3& other) : x(TrimFloat(other.x, 7)), y(TrimFloat(other.y, 7)), z(TrimFloat(other.z, 7)) {}
		V3(const Real& x, const Real& y, const Real& z) : x(x), y(y), z(z) {}
		V3(const V3& other) : x(other.x), y(other.y), z(other.z) {}

		//V3(const I3& other) : x((float)other.x), y((float)other.y), z((float)other.z) {}

		inline V3 operator - () { return V3(-x, -y, -z); }

		inline V3 operator + (const Real& scalar) { return V3(x + scalar, y + scalar, z + scalar); }
		inline V3 operator - (const Real& scalar) { return V3(x - scalar, y - scalar, z - scalar); }
		inline V3 operator * (const Real& scalar) { return V3(x * scalar, y * scalar, z * scalar); }
		inline V3 operator / (const Real& scalar) { return V3(x / scalar, y / scalar, z / scalar); }

		inline void operator += (const Real& scalar) { x += scalar; y += scalar; z += scalar; }
		inline void operator -= (const Real& scalar) { x -= scalar; y -= scalar; z -= scalar; }
		inline void operator *= (const Real& scalar) { x *= scalar; y *= scalar; z *= scalar; }
		inline void operator /= (const Real& scalar) { x /= scalar; y /= scalar; z /= scalar; }
		...
		inline Real length() { return Real(sqrt((x * x + y * y + z * z).Double())); }
		inline Real lengthSquared() { return x * x + y * y + z * z; }
		...
		inline Real operator * (const V3& other) const
		{
		...
		static Real Length(const V3& v0, const V3& v1)
		{
			return (v1 - v0).length();
		}

		static Real LengthSquared(const V3& v0, const V3& v1)
		{
		...
		static V3 Min()
		{
			return V3(Real::Min(), Real::Min(), Real::Min());
		}

		static V3 Max()
		{
			return V3(Real::Max(), Real::Max(), Real::Max());
		}
	};
	...
	struct V3V3
	{
		...
		inline V3V3 operator + (const Real& scalar) { return V3V3(v0 + scalar, v1 + scalar); }
		inline V3V3 operator - (const Real& scalar) { return V3V3(v0 - scalar, v1 - scalar); }
		inline V3V3 operator * (const Real& scalar) { return V3V3(v0 * scalar, v1 * scalar); }
		inline V3V3 operator / (const Real& scalar) { return V3V3(v0 / scalar, v1 / scalar); }

		inline void operator += (const Real& scalar) { v0 += scalar; v1 += scalar; }
		inline void operator -= (const Real& scalar) { v0 -= scalar; v1 -= scalar; }
		inline void operator *= (const Real& scalar) { v0 *= scalar; v1 *= scalar; }
		inline void operator /= (const Real& scalar) { v0 /= scalar; v1 /= scalar; }
	...
	struct V3V3V3
	{
		...
		inline V3V3V3 operator + (const Real& scalar) { return V3V3V3(v0 + scalar, v1 + scalar, v2 + scalar); }
		inline V3V3V3 operator - (const Real& scalar) { return V3V3V3(v0 - scalar, v1 - scalar, v2 - scalar); }
		inline V3V3V3 operator * (const Real& scalar) { return V3V3V3(v0 * scalar, v1 * scalar, v2 * scalar); }
		inline V3V3V3 operator / (const Real& scalar) { return V3V3V3(v0 / scalar, v1 / scalar, v2 / scalar); }

		inline void operator += (const Real& scalar) { v0 += scalar; v1 += scalar; v2 += scalar; }
		inline void operator -= (const Real& scalar) { v0 -= scalar; v1 -= scalar; v2 -= scalar; }
		inline void operator *= (const Real& scalar) { v0 *= scalar; v1 *= scalar; v2 *= scalar; }
		inline void operator /= (const Real& scalar) { v0 /= scalar; v1 /= scalar; v2 /= scalar; }
